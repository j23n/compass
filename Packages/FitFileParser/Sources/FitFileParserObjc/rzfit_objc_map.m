...
static FIT_FIELD_INFO rzfit_objc_field_info_for_training_settings(FIT_UINT16 field){
  switch( field ){
    case 2: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // virtual_partner_pace
    case 3: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // auto_lap_mode
    case 4: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // auto_lap_distance
    case 7: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // auto_pause
    case 8: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // auto_pause_threshold
    case 12: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // power_averaging
    case 15: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // auto_scroll
    case 18: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // timer_start_prompt
    case 22: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // pool_length
    case 25: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // auto_sleep
    case 27: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // satellites
    case 31: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // target_distance
    case 32: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // target_speed
    case 33: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // target_time
    case 35: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // speed_3_d
    case 36: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // distance_3_d
    case 37: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // auto_climb
    case 40: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // auto_climb_invert_colors
    case 41: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // auto_climb_vertical_speed
    case 42: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // auto_climb_mode_switch
    case 46: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // lap_key
    case 50: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // workout_target_alerts
    case 51: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // timer_start_auto
    case 52: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // segment_alerts
    case 57: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // countdown_start
    case 63: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // climb_pro
    case 67: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // track_consumption
    case 69: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // bottle_size
    case 70: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // volume
    case 80: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // minimum_ride_duration
    case 86: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // lane_number
    case 87: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // broadcast_heart_rate
    case 93: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // self_evaluation
    case 102: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // speed_pro
    case 103: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // touch
    case 106: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // record_temperature
    case 109: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // running_power_mode
    case 110: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // account_for_wind
    case 111: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // climb_pro_mode
    case 117: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // climb_detection
    case 119: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // climb_pro_terrain
    case 153: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // precise_target_speed
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
  }
}
static FIT_FIELD_INFO rzfit_objc_field_info_for_data_screen(FIT_UINT16 field){
  switch( field ){
    case 3: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // nr_fields
    case 7: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // data_fields
    case 8: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // layout
    case 9: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // position
    case 10: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // screen_type
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
  }
}
static FIT_FIELD_INFO rzfit_objc_field_info_for_alert(FIT_UINT16 field){
  switch( field ){
    case 1: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // metric
    case 2: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // value
    case 3: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // status
    case 4: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // message
    case 5: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // repeat
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
  }
}
static FIT_FIELD_INFO rzfit_objc_field_info_for_range_alert(FIT_UINT16 field){
  switch( field ){
    case 1: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // metric
    case 2: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // low_status
    case 3: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // low_value
    case 4: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // high_status
    case 5: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // high_value
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
  }
}
static FIT_FIELD_INFO rzfit_objc_field_info_for_device_used(FIT_UINT16 field){
  switch( field ){
    case 0: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // speed
    case 1: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // distance
    case 2: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // cadence
    case 3: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // elevation
    case 4: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // heart_rate
    case 6: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // power
    case 253: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // timestamp
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
  }
}
static FIT_FIELD_INFO rzfit_objc_field_info_for_location(FIT_UINT16 field){
  switch( field ){
    case 1: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // position_lat
    case 2: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // position_long
    case 3: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // symbol
    case 4: return (FIT_FIELD_INFO){.scale = 0, .offset = 500, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // altitude
    case 5: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // enhanced_altitude
    case 6: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // description
    case 253: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // timestamp
    case 254: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // message_index
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
  }
}
static FIT_FIELD_INFO rzfit_objc_field_info_for_map_layer(FIT_UINT16 field){
  switch( field ){
    case 2: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // relief_shading
    case 11: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // orientation
    case 13: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // user_locations
    case 14: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // auto_zoom
    case 15: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // guide_text
    case 16: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // track_log
    case 20: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // courses
    case 23: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // spot_soundings
    case 24: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // light_sectors
    case 27: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // segments
    case 28: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // contours
    case 31: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // popularity
    case 253: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // timestamp
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
  }
}
static FIT_FIELD_INFO rzfit_objc_field_info_for_routing(FIT_UINT16 field){
  switch( field ){
    case 0: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // routing_mode
    case 1: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // calculation_method
    case 2: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // lock_on_road
    case 3: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // avoidances
    case 4: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // route_recalculation
    case 5: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // type
    case 7: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // course_recalculation
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
  }
}
static FIT_FIELD_INFO rzfit_objc_field_info_for_user_metrics(FIT_UINT16 field){
  switch( field ){
    case 0: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // vo2_max
    case 1: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // age
    case 2: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // height
    case 3: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // weight
    case 4: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // gender
    case 6: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // max_hr
    case 8: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // remaining_recovery_time
    case 11: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // lactate_threshold_heart_rate
    case 12: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // lactate_threshold_power
    case 13: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // lactate_threshold_speed
    case 15: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // beginning_body_battery
    case 16: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // start_of_activity
    case 19: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // first_vo2_max
    case 32: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // beginning_potential
    case 35: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // end_of_previous_activity
    case 39: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // wake_up_time
    case 253: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // timestamp
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
  }
}
static FIT_FIELD_INFO rzfit_objc_field_info_for_open_water_event(FIT_UINT16 field){
  switch( field ){
    case 0: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // event_type
    case 5: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // swim_stroke
    case 253: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // timestamp
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
  }
}
static FIT_FIELD_INFO rzfit_objc_field_info_for_device_status(FIT_UINT16 field){
  switch( field ){
    case 0: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // battery_voltage
    case 2: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // battery_level
    case 3: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // temperature
    case 253: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // timestamp
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
  }
}
static FIT_FIELD_INFO rzfit_objc_field_info_for_pad(FIT_UINT16 field){
  switch( field ){
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
  }
}
static FIT_FIELD_INFO rzfit_objc_field_info_for_best_effort(FIT_UINT16 field){
  switch( field ){
    case 1: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // sport
    case 2: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // distance
    case 3: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // time
    case 4: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // timestamp
    case 5: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // personal_record
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
  }
}
static FIT_FIELD_INFO rzfit_objc_field_info_for_personal_record(FIT_UINT16 field){
  switch( field ){
    case 0: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // metric
    case 1: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // sport
    case 2: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // distance
    case 5: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // record
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
  }
}
static FIT_FIELD_INFO rzfit_objc_field_info_for_physiological_metrics(FIT_UINT16 field){
  switch( field ){
    case 1: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // new_hr_max
    case 4: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // aerobic_effect
    case 7: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // met_max
    case 9: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // recovery_time
    case 11: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // sport
    case 14: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // lactate_threshold_heart_rate
    case 15: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // lactate_threshold_power
    case 16: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // lactate_threshold_speed
    case 17: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // ending_performance_condition
    case 20: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // anaerobic_effect
    case 25: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // ending_body_battery
    case 29: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // first_vo2_max
    case 41: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // primary_benefit
    case 48: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // local_timestamp
    case 50: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // ending_potential
    case 60: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // total_ascent
    case 61: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // total_descent
    case 62: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // average_power
    case 63: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // average_heart_rate
    case 253: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // timestamp
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
  }
}
static FIT_FIELD_INFO rzfit_objc_field_info_for_epo_status(FIT_UINT16 field){
  switch( field ){
    case 0: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // status
    case 1: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // start_time
    case 2: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // end_time
    case 253: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // timestamp
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
  }
}
static FIT_FIELD_INFO rzfit_objc_field_info_for_multisport_activity(FIT_UINT16 field){
  switch( field ){
    case 0: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // sport
    case 1: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // sub_sport
    case 2: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // lock_device
    case 3: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // name
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
  }
}
static FIT_FIELD_INFO rzfit_objc_field_info_for_sensor_settings(FIT_UINT16 field){
  switch( field ){
    case 0: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // ant_id
    case 2: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // name
    case 10: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // wheel_size_manual
    case 11: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // calibration_factor
    case 21: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // wheel_size_auto
    case 32: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // product
    case 33: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // manufacturer
    case 45: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // use_for_speed
    case 46: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // use_for_distance
    case 51: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // connection_type
    case 52: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // sensor_type
    case 91: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // product_name
    case 254: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // message_index
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
  }
}
static FIT_FIELD_INFO rzfit_objc_field_info_for_metronome(FIT_UINT16 field){
  switch( field ){
    case 0: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // enabled
    case 1: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // beats_per_minute
    case 2: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // alert_frequency
    case 3: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // sound_and_vibe
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
  }
}
static FIT_FIELD_INFO rzfit_objc_field_info_for_connect_iq_field(FIT_UINT16 field){
  switch( field ){
    case 1: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // app_id
    case 2: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // data_field
    case 100: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // screen_id
    case 101: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // field_bits
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
  }
}
static FIT_FIELD_INFO rzfit_objc_field_info_for_golf_course(FIT_UINT16 field){
  switch( field ){
    case 0: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // course_id
    case 1: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // name
    case 2: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // local_time
    case 3: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // start_time
    case 4: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // end_time
    case 8: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // out
    case 9: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // in
    case 10: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // total
    case 11: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // tee
    case 12: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // slope
    case 21: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // rating
    case 253: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // timestamp
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
  }
}
static FIT_FIELD_INFO rzfit_objc_field_info_for_golf_stats(FIT_UINT16 field){
  switch( field ){
    case 0: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // name
    case 2: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // out
    case 3: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // in
    case 4: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // total
    case 7: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // fairway_hit
    case 8: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // gir
    case 9: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // putts
    case 253: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // timestamp
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
  }
}
static FIT_FIELD_INFO rzfit_objc_field_info_for_score(FIT_UINT16 field){
  switch( field ){
    case 1: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // hole_number
    case 2: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // score
    case 5: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // putts
    case 6: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // fairway
    case 253: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // timestamp
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
  }
}
static FIT_FIELD_INFO rzfit_objc_field_info_for_hole(FIT_UINT16 field){
  switch( field ){
    case 0: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // hole_number
    case 1: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // distance
    case 2: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // par
    case 3: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // handicap
    case 4: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // position_lat
    case 5: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // position_long
    case 253: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // timestamp
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
  }
}
static FIT_FIELD_INFO rzfit_objc_field_info_for_shot(FIT_UINT16 field){
  switch( field ){
    case 1: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // hole_number
    case 2: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // start_position_lat
    case 3: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // start_position_long
    case 4: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // end_position_lat
    case 5: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // end_position_long
    case 7: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // club_type
    case 253: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // timestamp
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
  }
}
static FIT_FIELD_INFO rzfit_objc_field_info_for_alarm_settings(FIT_UINT16 field){
  switch( field ){
    case 0: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // time
    case 1: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // repeat
    case 2: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // enabled
    case 3: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // sound
    case 4: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // backlight
    case 5: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // time_created
    case 7: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // unknown7
    case 8: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // label
    case 11: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // time_updated
    case 254: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // message_index
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
  }
}
static FIT_FIELD_INFO rzfit_objc_field_info_for_music_info(FIT_UINT16 field){
  switch( field ){
    case 0: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // start_time
    case 2: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // title
    case 3: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // artist
    case 4: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // genre
    case 5: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // duration
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
  }
}
static FIT_FIELD_INFO rzfit_objc_field_info_for_sleep_data_info(FIT_UINT16 field){
  switch( field ){
    case 0: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // unk0
    case 1: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // sample_length
    case 2: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // local_timestamp
    case 3: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // unk3
    case 4: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // version
    case 253: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // timestamp
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
  }
}
static FIT_FIELD_INFO rzfit_objc_field_info_for_sleep_data_raw(FIT_UINT16 field){
  switch( field ){
    case 0: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // bytes
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
  }
}
static FIT_FIELD_INFO rzfit_objc_field_info_for_aad_accel_features(FIT_UINT16 field){
  switch( field ){
    ...
    case 4: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // time_above_threshold
    case 253: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // timestamp
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
  }
}
static FIT_FIELD_INFO rzfit_objc_field_info_for_hsa_accelerometer_data(FIT_UINT16 field){
  switch( field ){
    case 0: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // timestamp_ms
    case 1: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // sampling_interval
    case 2: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // accel_x
    case 3: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // accel_y
    case 4: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // accel_z
...
static FIT_FIELD_INFO rzfit_objc_field_info_for_hsa_step_data(FIT_UINT16 field){
  switch( field ){
    case 0: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // processing_interval
    case 1: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // steps
    case 253: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // timestamp
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
  }
}
static FIT_FIELD_INFO rzfit_objc_field_info_for_hsa_spo2_data(FIT_UINT16 field){
  switch( field ){
    case 0: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // processing_interval
    case 1: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // reading_spo2
...
static FIT_FIELD_INFO rzfit_objc_field_info_for_hsa_stress_data(FIT_UINT16 field){
  switch( field ){
    case 0: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // processing_interval
    case 1: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // stress_level
    case 253: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // timestamp
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
  }
}
static FIT_FIELD_INFO rzfit_objc_field_info_for_hsa_respiration_data(FIT_UINT16 field){
  switch( field ){
    case 0: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // processing_interval
    case 1: return (FIT_FIELD_INFO){.scale = 0, .offset = 100, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // respiration_rate
    case 253: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // timestamp
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
  }
}
static FIT_FIELD_INFO rzfit_objc_field_info_for_hsa_heart_rate_data(FIT_UINT16 field){
  switch( field ){
    ...
    case 2: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // heart_rate
    case 253: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // timestamp
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
  }
}
static FIT_FIELD_INFO rzfit_objc_field_info_for_mtb_cx(FIT_UINT16 field){
  switch( field ){
    case 1: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // grit_flow_jump_recording
    case 2: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // jump_alerts
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
  }
}
static FIT_FIELD_INFO rzfit_objc_field_info_for_race(FIT_UINT16 field){
  switch( field ){
    case 3: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // goal_time
    case 4: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // goal_speed
    case 5: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // distance
    case 7: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // split_distance
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
  }
}
static FIT_FIELD_INFO rzfit_objc_field_info_for_split_time(FIT_UINT16 field){
  switch( field ){
    case 0: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // time
    case 1: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // distance
    case 2: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // split_time
    case 3: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // split_distance
    case 4: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // split_speed
    case 9: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // start_position_lat
    case 10: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // start_position_long
    case 11: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // end_position_lat
    case 12: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // end_position_long
    case 13: return (FIT_FIELD_INFO){.scale = 0, .offset = 5, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // start_altitude
    case 14: return (FIT_FIELD_INFO){.scale = 0, .offset = 5, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // end_altitude
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
  }
}
static FIT_FIELD_INFO rzfit_objc_field_info_for_split_summary(FIT_UINT16 field){
  switch( field ){
    case 0: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // split_type
    case 3: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // num_splits
    case 4: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // total_timer_time
    case 5: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // total_distance
    case 6: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // avg_speed
    case 7: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // max_speed
    case 8: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // total_ascent
    case 9: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // total_descent
    case 10: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // avg_heart_rate
    case 11: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // max_heart_rate
    case 12: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // avg_vert_speed
    case 13: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // total_calories
    case 65: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // active_time
    case 77: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // total_moving_time
    case 253: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // timestamp
    case 254: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // message_index
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
  }
...
static FIT_FIELD_INFO rzfit_objc_field_info_for_hsa_body_battery_data(FIT_UINT16 field){
  switch( field ){
    case 0: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // processing_interval
    case 1: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // level
...
static FIT_FIELD_INFO rzfit_objc_field_info_for_power_mode(FIT_UINT16 field){
  switch( field ){
    case 0: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // low_battery_alert
    case 1: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // default_mode
    case 3: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // auto_enable_time
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
  }
}
static FIT_FIELD_INFO rzfit_objc_field_info_for_gps_event(FIT_UINT16 field){
  switch( field ){
    case 0: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // event_type
...
static FIT_FIELD_INFO rzfit_objc_field_info_for_ecg_summary(FIT_UINT16 field){
  switch( field ){
    case 0: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // unknown_0
    case 1: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // unknown_1
    case 2: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // raw_sample_rate
    case 3: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // smooth_sample_rate
    case 4: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // ecg_timestamp
    case 5: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // local_timestamp
    case 6: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // unknown_6
    case 7: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // average_heart_rate
    case 10: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // unknown_10
    case 11: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // sample_time
    case 12: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // sdrr_hrv
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
  }
}
static FIT_FIELD_INFO rzfit_objc_field_info_for_ecg_raw_sample(FIT_UINT16 field){
  switch( field ){
    case 0: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // value
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
  }
}
static FIT_FIELD_INFO rzfit_objc_field_info_for_ecg_smooth_sample(FIT_UINT16 field){
  switch( field ){
    case 0: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // value
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
  }
}
static FIT_FIELD_INFO rzfit_objc_field_info_for_functional_metrics(FIT_UINT16 field){
  switch( field ){
    case 0: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // unknown_0
    case 2: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // unknown_2
    case 3: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // unknown_3
    case 4: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // functional_threshold_power
    case 5: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // unknown_5
    case 6: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // unknown_6
    case 7: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // running_lactate_threshold_power
    case 8: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // running_lactate_threshold_hr
    case 9: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // cycling_lactace_threshold_hr
    case 10: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // unknown_10
    case 11: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // unknown_11
    case 12: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // unknown_12
    case 253: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // timestamp
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
  }
}
static FIT_FIELD_INFO rzfit_objc_field_info_for_race_event(FIT_UINT16 field){
  switch( field ){
    case 1: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // event_id
    case 2: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // start_time
    case 3: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // local_timestamp
    case 4: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // name
    case 5: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // location
    case 6: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // start_point_lat
    case 7: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // start_point_long
    case 10: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // distance
    case 12: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // target_time
    case 24: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // city
    case 26: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // country
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
  }
}
static FIT_FIELD_INFO rzfit_objc_field_info_for_training_readiness(FIT_UINT16 field){
  switch( field ){
    case 0: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // training_readiness
    case 1: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // level
    case 2: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // unknown_2
    case 3: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // unknown_3
    case 4: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // unknown_4
    case 5: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // unknown_5
    case 6: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // unknown_6
    case 7: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // unknown_7
    case 8: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // unknown_8
    case 9: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // unknown_9
    case 10: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // unknown_10
    case 11: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // unknown_11
    case 12: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // unknown_12
    case 13: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // unknown_13
    case 14: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // unknown_14
    case 15: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // unknown_15
    case 16: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // unknown_16
    case 17: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // unknown_17
    case 18: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // unknown_18
    case 19: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // unknown_19
    case 20: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // local_timestamp
    case 21: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // unknown_21
    case 22: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // unknown_22
    case 25: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // unknown_25
    case 26: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // unknown_26
    case 27: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // unknown_27
    case 28: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // unknown_28
    case 29: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // unknown_29
    case 30: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // unknown_30
    case 253: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // timestamp
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
  }
}
static FIT_FIELD_INFO rzfit_objc_field_info_for_raw_bbi(FIT_UINT16 field){
  switch( field ){
    case 0: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // timestamp_ms
    case 1: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // data
    case 2: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // time
...
static FIT_FIELD_INFO rzfit_objc_field_info_for_hsa_gyroscope_data(FIT_UINT16 field){
  switch( field ){
    case 0: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // timestamp_ms
    case 1: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // sampling_interval
    case 2: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // gyro_x
    case 3: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // gyro_y
    case 4: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // gyro_z
    case 5: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // timestamp_32k
    case 253: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // timestamp
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
  }
}
static FIT_FIELD_INFO rzfit_objc_field_info_for_training_load(FIT_UINT16 field){
  switch( field ){
    case 3: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // training_load_acute
    case 4: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // training_load_chronic
    case 253: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // timestamp
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
  }
}
static FIT_FIELD_INFO rzfit_objc_field_info_for_sleep_schedule(FIT_UINT16 field){
  switch( field ){
    case 0: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // bed_time
    case 1: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // wake_time
    case 254: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // message_index
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
  }
}
static FIT_FIELD_INFO rzfit_objc_field_info_for_sleep_restless_moments(FIT_UINT16 field){
  switch( field ){
    case 0: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // unknown_0
    case 1: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // restless_moments_count
    case 2: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // durations
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
  }
}
static FIT_FIELD_INFO rzfit_objc_field_info_for_chrono_shot_session(FIT_UINT16 field){
  switch( field ){
    case 0: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // min_speed
    case 1: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // max_speed
    case 2: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // avg_speed
    case 3: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // shot_count
    case 4: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // projectile_type
    case 5: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // grain_weight
    case 6: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // standard_deviation
    case 253: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // timestamp
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
  }
}
static FIT_FIELD_INFO rzfit_objc_field_info_for_chrono_shot_data(FIT_UINT16 field){
  switch( field ){
    case 0: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // shot_speed
...
static FIT_FIELD_INFO rzfit_objc_field_info_for_cpe_status(FIT_UINT16 field){
  switch( field ){
    case 0: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // status
    case 1: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // start_time
    case 2: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // end_time
...
static FIT_FIELD_INFO rzfit_objc_field_info_for_skin_temp_raw(FIT_UINT16 field){
  switch( field ){
    case 1: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // deviation
    case 253: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // timestamp
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
  }
}
static FIT_FIELD_INFO rzfit_objc_field_info_for_skin_temp_overnight(FIT_UINT16 field){
  switch( field ){
    case 0: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // local_timestamp
...
static FIT_FIELD_INFO rzfit_objc_field_info_for_hill_score(FIT_UINT16 field){
  switch( field ){
    case 0: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // hill_score
    case 1: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // hill_strength
    case 2: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // hill_endurance
    case 3: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // unknown_3
    case 4: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // level
    case 5: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // unknown_5
    case 253: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // timestamp
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
  }
}
static FIT_FIELD_INFO rzfit_objc_field_info_for_endurance_score(FIT_UINT16 field){
  switch( field ){
    case 0: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // endurance_score
    case 1: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // level
    case 2: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // unknown_2
    case 3: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // lower_bound_intermediate
    case 4: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // lower_bound_trained
    case 5: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // lower_bound_well_trained
    case 6: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // lower_bound_expert
    case 7: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // lower_bound_superior
    case 8: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // lower_bound_elite
    case 9: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // unknown_9
    case 10: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // unknown_10
    case 253: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // timestamp
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
...
static FIT_FIELD_INFO rzfit_objc_field_info_for_hsa_wrist_temperature_data(FIT_UINT16 field){
  switch( field ){
    case 0: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // processing_interval
    case 1: return (FIT_FIELD_INFO){.scale = 0, .offset = 1000, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // value
    case 253: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // timestamp
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
  }
}
static FIT_FIELD_INFO rzfit_objc_field_info_for_nap(FIT_UINT16 field){
  switch( field ){
    case 0: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // start_timestamp
    case 1: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // start_tz_offset
    case 2: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // end_timestamp
    case 3: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // end_tz_offset
    case 4: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // feedback
    case 6: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // deleted
    case 7: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // updated_timestamp
    case 253: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // timestamp
    case 254: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // message_index
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
  }
}
static FIT_FIELD_INFO rzfit_objc_field_info_for_workout_schedule(FIT_UINT16 field){
  switch( field ){
    case 1: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // workout_index
    case 3: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // est_benefit
    case 5: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // est_aerobic_te
    case 6: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // est_anaer_te
    case 7: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // sport
    case 9: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // duration
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
  }
}
static FIT_FIELD_INFO rzfit_objc_field_info_for_sleep_disruption_severity_period(FIT_UINT16 field){
  switch( field ){
    case 0: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // severity
    case 253: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // timestamp
    case 254: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // message_index
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
  }
}
static FIT_FIELD_INFO rzfit_objc_field_info_for_sleep_disruption_overnight_severity(FIT_UINT16 field){
  switch( field ){
    case 0: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // severity
    case 253: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 }; // timestamp
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
...
static NSString * rzfit_objc_field_num_to_string_for_training_settings( FIT_UINT8 field_num ){
  switch( field_num ){
    case 2: return @"virtual_partner_pace";
    case 3: return @"auto_lap_mode";
    case 4: return @"auto_lap_distance";
    case 7: return @"auto_pause";
    case 8: return @"auto_pause_threshold";
    case 12: return @"power_averaging";
    case 15: return @"auto_scroll";
    case 18: return @"timer_start_prompt";
    case 22: return @"pool_length";
    case 25: return @"auto_sleep";
    case 27: return @"satellites";
    case 31: return @"target_distance";
    case 32: return @"target_speed";
    case 33: return @"target_time";
    case 35: return @"speed_3_d";
    case 36: return @"distance_3_d";
    case 37: return @"auto_climb";
    case 40: return @"auto_climb_invert_colors";
    case 41: return @"auto_climb_vertical_speed";
    case 42: return @"auto_climb_mode_switch";
    case 46: return @"lap_key";
    case 50: return @"workout_target_alerts";
    case 51: return @"timer_start_auto";
    case 52: return @"segment_alerts";
    case 57: return @"countdown_start";
    case 63: return @"climb_pro";
    case 67: return @"track_consumption";
    case 69: return @"bottle_size";
    case 70: return @"volume";
    case 80: return @"minimum_ride_duration";
    case 86: return @"lane_number";
    case 87: return @"broadcast_heart_rate";
    case 93: return @"self_evaluation";
    case 102: return @"speed_pro";
    case 103: return @"touch";
    case 106: return @"record_temperature";
    case 109: return @"running_power_mode";
    case 110: return @"account_for_wind";
    case 111: return @"climb_pro_mode";
    case 117: return @"climb_detection";
    case 119: return @"climb_pro_terrain";
...
static NSString * rzfit_objc_field_num_to_string_for_data_screen( FIT_UINT8 field_num ){
  switch( field_num ){
    case 3: return @"nr_fields";
    case 7: return @"data_fields";
    case 8: return @"layout";
    case 9: return @"position";
    case 10: return @"screen_type";
    default: return [NSString stringWithFormat:@"data_screen_field_num_%u", (unsigned int)field_num];
  }
}

static NSString * rzfit_objc_field_num_to_string_for_alert( FIT_UINT8 field_num ){
  switch( field_num ){
    ...
    default: return [NSString stringWithFormat:@"alert_field_num_%u", (unsigned int)field_num];
  }
}

static NSString * rzfit_objc_field_num_to_string_for_range_alert( FIT_UINT8 field_num ){
  switch( field_num ){
    case 1: return @"metric";
    case 2: return @"low_status";
    case 3: return @"low_value";
    case 4: return @"high_status";
    case 5: return @"high_value";
    default: return [NSString stringWithFormat:@"range_alert_field_num_%u", (unsigned int)field_num];
  }
}

static NSString * rzfit_objc_field_num_to_string_for_device_used( FIT_UINT8 field_num ){
  switch( field_num ){
    case 0: return @"speed";
    case 1: return @"distance";
    case 2: return @"cadence";
    ...
    case 6: return @"power";
    case 253: return @"timestamp";
    default: return [NSString stringWithFormat:@"device_used_field_num_%u", (unsigned int)field_num];
  }
}

static NSString * rzfit_objc_field_num_to_string_for_location( FIT_UINT8 field_num ){
  switch( field_num ){
    case 1: return @"position_lat";
    case 2: return @"position_long";
    case 3: return @"symbol";
    case 4: return @"altitude";
    case 5: return @"enhanced_altitude";
    case 6: return @"description";
    case 253: return @"timestamp";
    case 254: return @"message_index";
    default: return [NSString stringWithFormat:@"location_field_num_%u", (unsigned int)field_num];
  }
}

static NSString * rzfit_objc_field_num_to_string_for_map_layer( FIT_UINT8 field_num ){
  switch( field_num ){
    case 2: return @"relief_shading";
    case 11: return @"orientation";
    case 13: return @"user_locations";
    case 14: return @"auto_zoom";
    case 15: return @"guide_text";
    case 16: return @"track_log";
    case 20: return @"courses";
    case 23: return @"spot_soundings";
    case 24: return @"light_sectors";
    case 27: return @"segments";
    case 28: return @"contours";
    case 31: return @"popularity";
    case 253: return @"timestamp";
    default: return [NSString stringWithFormat:@"map_layer_field_num_%u", (unsigned int)field_num];
  }
}

static NSString * rzfit_objc_field_num_to_string_for_routing( FIT_UINT8 field_num ){
  switch( field_num ){
    case 0: return @"routing_mode";
    case 1: return @"calculation_method";
    case 2: return @"lock_on_road";
    case 3: return @"avoidances";
    case 4: return @"route_recalculation";
    case 5: return @"type";
    case 7: return @"course_recalculation";
    default: return [NSString stringWithFormat:@"routing_field_num_%u", (unsigned int)field_num];
  }
}

static NSString * rzfit_objc_field_num_to_string_for_user_metrics( FIT_UINT8 field_num ){
  switch( field_num ){
    case 0: return @"vo2_max";
    case 1: return @"age";
    case 2: return @"height";
    case 3: return @"weight";
    case 4: return @"gender";
    case 6: return @"max_hr";
    case 8: return @"remaining_recovery_time";
    case 11: return @"lactate_threshold_heart_rate";
    case 12: return @"lactate_threshold_power";
    case 13: return @"lactate_threshold_speed";
    case 15: return @"beginning_body_battery";
    case 16: return @"start_of_activity";
    case 19: return @"first_vo2_max";
    case 32: return @"beginning_potential";
    case 35: return @"end_of_previous_activity";
    case 39: return @"wake_up_time";
    case 253: return @"timestamp";
    default: return [NSString stringWithFormat:@"user_metrics_field_num_%u", (unsigned int)field_num];
  }
}

static NSString * rzfit_objc_field_num_to_string_for_open_water_event( FIT_UINT8 field_num ){
  switch( field_num ){
    case 0: return @"event_type";
    case 5: return @"swim_stroke";
    case 253: return @"timestamp";
    default: return [NSString stringWithFormat:@"open_water_event_field_num_%u", (unsigned int)field_num];
  }
}

static NSString * rzfit_objc_field_num_to_string_for_device_status( FIT_UINT8 field_num ){
  switch( field_num ){
    case 0: return @"battery_voltage";
    case 2: return @"battery_level";
    case 3: return @"temperature";
    case 253: return @"timestamp";
    default: return [NSString stringWithFormat:@"device_status_field_num_%u", (unsigned int)field_num];
  }
}

static NSString * rzfit_objc_field_num_to_string_for_pad( FIT_UINT8 field_num ){
  switch( field_num ){
    default: return [NSString stringWithFormat:@"pad_field_num_%u", (unsigned int)field_num];
  }
}

static NSString * rzfit_objc_field_num_to_string_for_best_effort( FIT_UINT8 field_num ){
  switch( field_num ){
    case 1: return @"sport";
    case 2: return @"distance";
    case 3: return @"time";
    case 4: return @"timestamp";
    case 5: return @"personal_record";
    default: return [NSString stringWithFormat:@"best_effort_field_num_%u", (unsigned int)field_num];
  }
}

static NSString * rzfit_objc_field_num_to_string_for_personal_record( FIT_UINT8 field_num ){
  switch( field_num ){
    case 0: return @"metric";
    case 1: return @"sport";
    case 2: return @"distance";
    case 5: return @"record";
    default: return [NSString stringWithFormat:@"personal_record_field_num_%u", (unsigned int)field_num];
  }
}

static NSString * rzfit_objc_field_num_to_string_for_physiological_metrics( FIT_UINT8 field_num ){
  switch( field_num ){
    case 1: return @"new_hr_max";
    case 4: return @"aerobic_effect";
    case 7: return @"met_max";
    case 9: return @"recovery_time";
    case 11: return @"sport";
    case 14: return @"lactate_threshold_heart_rate";
    case 15: return @"lactate_threshold_power";
    case 16: return @"lactate_threshold_speed";
    case 17: return @"ending_performance_condition";
    case 20: return @"anaerobic_effect";
    case 25: return @"ending_body_battery";
    case 29: return @"first_vo2_max";
    case 41: return @"primary_benefit";
    case 48: return @"local_timestamp";
    case 50: return @"ending_potential";
    case 60: return @"total_ascent";
    case 61: return @"total_descent";
    case 62: return @"average_power";
    case 63: return @"average_heart_rate";
    case 253: return @"timestamp";
    default: return [NSString stringWithFormat:@"physiological_metrics_field_num_%u", (unsigned int)field_num];
  }
}

static NSString * rzfit_objc_field_num_to_string_for_epo_status( FIT_UINT8 field_num ){
  switch( field_num ){
    case 0: return @"status";
    case 1: return @"start_time";
    case 2: return @"end_time";
    case 253: return @"timestamp";
    default: return [NSString stringWithFormat:@"epo_status_field_num_%u", (unsigned int)field_num];
  }
}

static NSString * rzfit_objc_field_num_to_string_for_multisport_activity( FIT_UINT8 field_num ){
  switch( field_num ){
    case 0: return @"sport";
    case 1: return @"sub_sport";
    case 2: return @"lock_device";
    case 3: return @"name";
    default: return [NSString stringWithFormat:@"multisport_activity_field_num_%u", (unsigned int)field_num];
  }
}

static NSString * rzfit_objc_field_num_to_string_for_sensor_settings( FIT_UINT8 field_num ){
  switch( field_num ){
    case 0: return @"ant_id";
    case 2: return @"name";
    case 10: return @"wheel_size_manual";
    case 11: return @"calibration_factor";
    case 21: return @"wheel_size_auto";
    case 32: return @"product";
    case 33: return @"manufacturer";
    case 45: return @"use_for_speed";
    case 46: return @"use_for_distance";
    case 51: return @"connection_type";
    case 52: return @"sensor_type";
    case 91: return @"product_name";
    case 254: return @"message_index";
    default: return [NSString stringWithFormat:@"sensor_settings_field_num_%u", (unsigned int)field_num];
  }
}

static NSString * rzfit_objc_field_num_to_string_for_metronome( FIT_UINT8 field_num ){
  switch( field_num ){
    case 0: return @"enabled";
    case 1: return @"beats_per_minute";
    case 2: return @"alert_frequency";
    case 3: return @"sound_and_vibe";
    default: return [NSString stringWithFormat:@"metronome_field_num_%u", (unsigned int)field_num];
  }
}

static NSString * rzfit_objc_field_num_to_string_for_connect_iq_field( FIT_UINT8 field_num ){
  switch( field_num ){
    case 1: return @"app_id";
    case 2: return @"data_field";
    case 100: return @"screen_id";
    case 101: return @"field_bits";
    default: return [NSString stringWithFormat:@"connect_iq_field_field_num_%u", (unsigned int)field_num];
  }
}

static NSString * rzfit_objc_field_num_to_string_for_golf_course( FIT_UINT8 field_num ){
  switch( field_num ){
    case 0: return @"course_id";
    case 1: return @"name";
    case 2: return @"local_time";
    case 3: return @"start_time";
    case 4: return @"end_time";
    case 8: return @"out";
    case 9: return @"in";
    case 10: return @"total";
    case 11: return @"tee";
    case 12: return @"slope";
    case 21: return @"rating";
    case 253: return @"timestamp";
    default: return [NSString stringWithFormat:@"golf_course_field_num_%u", (unsigned int)field_num];
  }
}

static NSString * rzfit_objc_field_num_to_string_for_golf_stats( FIT_UINT8 field_num ){
  switch( field_num ){
    case 0: return @"name";
    case 2: return @"out";
    case 3: return @"in";
    case 4: return @"total";
    case 7: return @"fairway_hit";
    case 8: return @"gir";
    case 9: return @"putts";
    case 253: return @"timestamp";
    default: return [NSString stringWithFormat:@"golf_stats_field_num_%u", (unsigned int)field_num];
  }
}

static NSString * rzfit_objc_field_num_to_string_for_score( FIT_UINT8 field_num ){
  switch( field_num ){
    case 1: return @"hole_number";
    case 2: return @"score";
    case 5: return @"putts";
    case 6: return @"fairway";
    case 253: return @"timestamp";
    default: return [NSString stringWithFormat:@"score_field_num_%u", (unsigned int)field_num];
  }
}

static NSString * rzfit_objc_field_num_to_string_for_hole( FIT_UINT8 field_num ){
  switch( field_num ){
    case 0: return @"hole_number";
    case 1: return @"distance";
    case 2: return @"par";
    case 3: return @"handicap";
    case 4: return @"position_lat";
    case 5: return @"position_long";
    case 253: return @"timestamp";
    default: return [NSString stringWithFormat:@"hole_field_num_%u", (unsigned int)field_num];
  }
}

static NSString * rzfit_objc_field_num_to_string_for_shot( FIT_UINT8 field_num ){
  switch( field_num ){
    case 1: return @"hole_number";
    case 2: return @"start_position_lat";
    case 3: return @"start_position_long";
    case 4: return @"end_position_lat";
    case 5: return @"end_position_long";
    case 7: return @"club_type";
    case 253: return @"timestamp";
    default: return [NSString stringWithFormat:@"shot_field_num_%u", (unsigned int)field_num];
  }
}

static NSString * rzfit_objc_field_num_to_string_for_alarm_settings( FIT_UINT8 field_num ){
  switch( field_num ){
    case 0: return @"time";
    case 1: return @"repeat";
    case 2: return @"enabled";
    case 3: return @"sound";
    case 4: return @"backlight";
    case 5: return @"time_created";
    case 7: return @"unknown7";
    case 8: return @"label";
    case 11: return @"time_updated";
    case 254: return @"message_index";
    default: return [NSString stringWithFormat:@"alarm_settings_field_num_%u", (unsigned int)field_num];
  }
}

static NSString * rzfit_objc_field_num_to_string_for_music_info( FIT_UINT8 field_num ){
  switch( field_num ){
    ...
    default: return [NSString stringWithFormat:@"music_info_field_num_%u", (unsigned int)field_num];
  }
}

static NSString * rzfit_objc_field_num_to_string_for_sleep_data_info( FIT_UINT8 field_num ){
  switch( field_num ){
    case 0: return @"unk0";
    case 1: return @"sample_length";
    case 2: return @"local_timestamp";
    case 3: return @"unk3";
    case 4: return @"version";
    case 253: return @"timestamp";
    default: return [NSString stringWithFormat:@"sleep_data_info_field_num_%u", (unsigned int)field_num];
  }
}

static NSString * rzfit_objc_field_num_to_string_for_sleep_data_raw( FIT_UINT8 field_num ){
  switch( field_num ){
    case 0: return @"bytes";
    default: return [NSString stringWithFormat:@"sleep_data_raw_field_num_%u", (unsigned int)field_num];
  }
}
...
static NSString * rzfit_objc_field_num_to_string_for_mtb_cx( FIT_UINT8 field_num ){
  switch( field_num ){
    case 1: return @"grit_flow_jump_recording";
    case 2: return @"jump_alerts";
    default: return [NSString stringWithFormat:@"mtb_cx_field_num_%u", (unsigned int)field_num];
  }
}

static NSString * rzfit_objc_field_num_to_string_for_race( FIT_UINT8 field_num ){
  switch( field_num ){
    case 3: return @"goal_time";
    case 4: return @"goal_speed";
    case 5: return @"distance";
    case 7: return @"split_distance";
    default: return [NSString stringWithFormat:@"race_field_num_%u", (unsigned int)field_num];
  }
}

static NSString * rzfit_objc_field_num_to_string_for_split_time( FIT_UINT8 field_num ){
  switch( field_num ){
    case 0: return @"time";
    case 1: return @"distance";
    case 2: return @"split_time";
    case 3: return @"split_distance";
    case 4: return @"split_speed";
    case 9: return @"start_position_lat";
    case 10: return @"start_position_long";
    case 11: return @"end_position_lat";
    case 12: return @"end_position_long";
    case 13: return @"start_altitude";
    case 14: return @"end_altitude";
    default: return [NSString stringWithFormat:@"split_time_field_num_%u", (unsigned int)field_num];
  }
}
...
static NSString * rzfit_objc_field_num_to_string_for_power_mode( FIT_UINT8 field_num ){
  switch( field_num ){
    case 0: return @"low_battery_alert";
    case 1: return @"default_mode";
    case 3: return @"auto_enable_time";
    default: return [NSString stringWithFormat:@"power_mode_field_num_%u", (unsigned int)field_num];
  }
}

static NSString * rzfit_objc_field_num_to_string_for_gps_event( FIT_UINT8 field_num ){
  switch( field_num ){
    case 0: return @"event_type";
    case 1: return @"data";
    case 253: return @"timestamp";
    default: return [NSString stringWithFormat:@"gps_event_field_num_%u", (unsigned int)field_num];
  }
}

static NSString * rzfit_objc_field_num_to_string_for_ecg_summary( FIT_UINT8 field_num ){
  switch( field_num ){
    case 0: return @"unknown_0";
    case 1: return @"unknown_1";
    case 2: return @"raw_sample_rate";
    case 3: return @"smooth_sample_rate";
    case 4: return @"ecg_timestamp";
    case 5: return @"local_timestamp";
    case 6: return @"unknown_6";
    case 7: return @"average_heart_rate";
    case 10: return @"unknown_10";
    case 11: return @"sample_time";
    case 12: return @"sdrr_hrv";
    default: return [NSString stringWithFormat:@"ecg_summary_field_num_%u", (unsigned int)field_num];
  }
}

static NSString * rzfit_objc_field_num_to_string_for_ecg_raw_sample( FIT_UINT8 field_num ){
  switch( field_num ){
    case 0: return @"value";
    default: return [NSString stringWithFormat:@"ecg_raw_sample_field_num_%u", (unsigned int)field_num];
  }
}

static NSString * rzfit_objc_field_num_to_string_for_ecg_smooth_sample( FIT_UINT8 field_num ){
  switch( field_num ){
    case 0: return @"value";
    default: return [NSString stringWithFormat:@"ecg_smooth_sample_field_num_%u", (unsigned int)field_num];
  }
}

static NSString * rzfit_objc_field_num_to_string_for_functional_metrics( FIT_UINT8 field_num ){
  switch( field_num ){
    case 0: return @"unknown_0";
    case 2: return @"unknown_2";
    case 3: return @"unknown_3";
    case 4: return @"functional_threshold_power";
    case 5: return @"unknown_5";
    case 6: return @"unknown_6";
    case 7: return @"running_lactate_threshold_power";
    case 8: return @"running_lactate_threshold_hr";
    case 9: return @"cycling_lactace_threshold_hr";
    case 10: return @"unknown_10";
    case 11: return @"unknown_11";
    case 12: return @"unknown_12";
    case 253: return @"timestamp";
    default: return [NSString stringWithFormat:@"functional_metrics_field_num_%u", (unsigned int)field_num];
  }
}

static NSString * rzfit_objc_field_num_to_string_for_race_event( FIT_UINT8 field_num ){
  switch( field_num ){
    ...
    case 6: return @"start_point_lat";
    case 7: return @"start_point_long";
    case 10: return @"distance";
    case 12: return @"target_time";
    case 24: return @"city";
    case 26: return @"country";
    default: return [NSString stringWithFormat:@"race_event_field_num_%u", (unsigned int)field_num];
  }
}

static NSString * rzfit_objc_field_num_to_string_for_training_readiness( FIT_UINT8 field_num ){
  switch( field_num ){
    case 0: return @"training_readiness";
    case 1: return @"level";
    case 2: return @"unknown_2";
    case 3: return @"unknown_3";
    ...
    case 20: return @"local_timestamp";
    case 21: return @"unknown_21";
    case 22: return @"unknown_22";
    case 25: return @"unknown_25";
    ...
    case 253: return @"timestamp";
    default: return [NSString stringWithFormat:@"training_readiness_field_num_%u", (unsigned int)field_num];
  }
}
...
static NSString * rzfit_objc_field_num_to_string_for_training_load( FIT_UINT8 field_num ){
  switch( field_num ){
    case 3: return @"training_load_acute";
    case 4: return @"training_load_chronic";
    case 253: return @"timestamp";
    default: return [NSString stringWithFormat:@"training_load_field_num_%u", (unsigned int)field_num];
  }
}

static NSString * rzfit_objc_field_num_to_string_for_sleep_schedule( FIT_UINT8 field_num ){
  switch( field_num ){
    case 0: return @"bed_time";
    case 1: return @"wake_time";
    case 254: return @"message_index";
    default: return [NSString stringWithFormat:@"sleep_schedule_field_num_%u", (unsigned int)field_num];
  }
}

static NSString * rzfit_objc_field_num_to_string_for_sleep_restless_moments( FIT_UINT8 field_num ){
  switch( field_num ){
    case 0: return @"unknown_0";
    case 1: return @"restless_moments_count";
    case 2: return @"durations";
    default: return [NSString stringWithFormat:@"sleep_restless_moments_field_num_%u", (unsigned int)field_num];
  }
}
...
static NSString * rzfit_objc_field_num_to_string_for_cpe_status( FIT_UINT8 field_num ){
  switch( field_num ){
    case 0: return @"status";
    case 1: return @"start_time";
    case 2: return @"end_time";
    case 253: return @"timestamp";
    default: return [NSString stringWithFormat:@"cpe_status_field_num_%u", (unsigned int)field_num];
  }
}

static NSString * rzfit_objc_field_num_to_string_for_skin_temp_raw( FIT_UINT8 field_num ){
  switch( field_num ){
    case 1: return @"deviation";
    case 253: return @"timestamp";
    default: return [NSString stringWithFormat:@"skin_temp_raw_field_num_%u", (unsigned int)field_num];
  }
}
...
static NSString * rzfit_objc_field_num_to_string_for_hill_score( FIT_UINT8 field_num ){
  switch( field_num ){
    case 0: return @"hill_score";
    case 1: return @"hill_strength";
    case 2: return @"hill_endurance";
    case 3: return @"unknown_3";
    case 4: return @"level";
    case 5: return @"unknown_5";
    case 253: return @"timestamp";
    default: return [NSString stringWithFormat:@"hill_score_field_num_%u", (unsigned int)field_num];
  }
}

static NSString * rzfit_objc_field_num_to_string_for_endurance_score( FIT_UINT8 field_num ){
  switch( field_num ){
    case 0: return @"endurance_score";
    case 1: return @"level";
    case 2: return @"unknown_2";
    case 3: return @"lower_bound_intermediate";
    case 4: return @"lower_bound_trained";
    case 5: return @"lower_bound_well_trained";
    case 6: return @"lower_bound_expert";
    case 7: return @"lower_bound_superior";
    case 8: return @"lower_bound_elite";
    case 9: return @"unknown_9";
    case 10: return @"unknown_10";
    case 253: return @"timestamp";
    default: return [NSString stringWithFormat:@"endurance_score_field_num_%u", (unsigned int)field_num];
  }
}
...
static NSString * rzfit_objc_field_num_to_string_for_nap( FIT_UINT8 field_num ){
  switch( field_num ){
    case 0: return @"start_timestamp";
    case 1: return @"start_tz_offset";
    case 2: return @"end_timestamp";
    case 3: return @"end_tz_offset";
    case 4: return @"feedback";
    case 6: return @"deleted";
    case 7: return @"updated_timestamp";
    case 253: return @"timestamp";
    case 254: return @"message_index";
    default: return [NSString stringWithFormat:@"nap_field_num_%u", (unsigned int)field_num];
  }
}

static NSString * rzfit_objc_field_num_to_string_for_workout_schedule( FIT_UINT8 field_num ){
  switch( field_num ){
    case 1: return @"workout_index";
    case 3: return @"est_benefit";
    case 5: return @"est_aerobic_te";
    case 6: return @"est_anaer_te";
    case 7: return @"sport";
    case 9: return @"duration";
    default: return [NSString stringWithFormat:@"workout_schedule_field_num_%u", (unsigned int)field_num];
  }
}

static NSString * rzfit_objc_field_num_to_string_for_sleep_disruption_severity_period( FIT_UINT8 field_num ){
  switch( field_num ){
    case 0: return @"severity";
    case 253: return @"timestamp";
    case 254: return @"message_index";
    default: return [NSString stringWithFormat:@"sleep_disruption_severity_period_field_num_%u", (unsigned int)field_num];
  }
}

static NSString * rzfit_objc_field_num_to_string_for_sleep_disruption_overnight_severity( FIT_UINT8 field_num ){
  switch( field_num ){
    case 0: return @"severity";
    case 253: return @"timestamp";
    default: return [NSString stringWithFormat:@"sleep_disruption_overnight_severity_field_num_%u", (unsigned int)field_num];
  }
}
...
NSString * rzfit_objc_string_from_mesg_num( FIT_UINT16 mesg_num ){
  switch(mesg_num){
    ...
    case 14: return @"data_screen";
    case 16: return @"alert";
    case 17: return @"range_alert";
    case 22: return @"device_used";
    case 29: return @"location";
    case 70: return @"map_layer";
    case 71: return @"routing";
    case 79: return @"user_metrics";
    case 89: return @"open_water_event";
    case 104: return @"device_status";
    case 113: return @"best_effort";
    case 114: return @"personal_record";
    case 140: return @"physiological_metrics";
    case 141: return @"epo_status";
    case 144: return @"multisport_activity";
    case 147: return @"sensor_settings";
    case 152: return @"metronome";
    case 170: return @"connect_iq_field";
    case 190: return @"golf_course";
    case 191: return @"golf_stats";
    case 192: return @"score";
    case 193: return @"hole";
    case 194: return @"shot";
    case 222: return @"alarm_settings";
    case 243: return @"music_info";
    case 273: return @"sleep_data_info";
    case 274: return @"sleep_data_raw";
    ...
    case 309: return @"mtb_cx";
    case 310: return @"race";
    case 311: return @"split_time";
    case 313: return @"split_summary";
    case 314: return @"hsa_body_battery_data";
    case 315: return @"hsa_event";
    case 321: return @"power_mode";
    case 326: return @"gps_event";
    case 336: return @"ecg_summary";
    case 337: return @"ecg_raw_sample";
    case 338: return @"ecg_smooth_sample";
    case 356: return @"functional_metrics";
    case 358: return @"race_event";
    case 369: return @"training_readiness";
    case 372: return @"raw_bbi";
    case 376: return @"hsa_gyroscope_data";
    case 378: return @"training_load";
    case 379: return @"sleep_schedule";
    case 382: return @"sleep_restless_moments";
    case 387: return @"chrono_shot_session";
    case 388: return @"chrono_shot_data";
    case 389: return @"hsa_configuration_data";
    case 394: return @"cpe_status";
    case 397: return @"skin_temp_raw";
    case 398: return @"skin_temp_overnight";
    case 402: return @"hill_score";
    case 403: return @"endurance_score";
    case 409: return @"hsa_wrist_temperature_data";
    case 412: return @"nap";
    case 428: return @"workout_schedule";
    case 470: return @"sleep_disruption_severity_period";
    case 471: return @"sleep_disruption_overnight_severity";
...
NSString * rzfit_objc_field_num_to_string( FIT_UINT16 global_mesg_num, FIT_UINT16 field, FIT_INTERP_FIELD * interp ){
  switch( global_mesg_num ){
   ...
   case 105: return rzfit_objc_field_num_to_string_for_pad(field);
   ...
   case 14: return rzfit_objc_field_num_to_string_for_data_screen(field);
   case 16: return rzfit_objc_field_num_to_string_for_alert(field);
   case 17: return rzfit_objc_field_num_to_string_for_range_alert(field);
   case 22: return rzfit_objc_field_num_to_string_for_device_used(field);
   case 29: return rzfit_objc_field_num_to_string_for_location(field);
   case 70: return rzfit_objc_field_num_to_string_for_map_layer(field);
   case 71: return rzfit_objc_field_num_to_string_for_routing(field);
   case 79: return rzfit_objc_field_num_to_string_for_user_metrics(field);
   case 89: return rzfit_objc_field_num_to_string_for_open_water_event(field);
   case 104: return rzfit_objc_field_num_to_string_for_device_status(field);
   case 113: return rzfit_objc_field_num_to_string_for_best_effort(field);
   case 114: return rzfit_objc_field_num_to_string_for_personal_record(field);
   case 140: return rzfit_objc_field_num_to_string_for_physiological_metrics(field);
   case 141: return rzfit_objc_field_num_to_string_for_epo_status(field);
   case 144: return rzfit_objc_field_num_to_string_for_multisport_activity(field);
   case 147: return rzfit_objc_field_num_to_string_for_sensor_settings(field);
   case 152: return rzfit_objc_field_num_to_string_for_metronome(field);
   case 170: return rzfit_objc_field_num_to_string_for_connect_iq_field(field);
   case 190: return rzfit_objc_field_num_to_string_for_golf_course(field);
   case 191: return rzfit_objc_field_num_to_string_for_golf_stats(field);
   case 192: return rzfit_objc_field_num_to_string_for_score(field);
   case 193: return rzfit_objc_field_num_to_string_for_hole(field);
   case 194: return rzfit_objc_field_num_to_string_for_shot(field);
   case 222: return rzfit_objc_field_num_to_string_for_alarm_settings(field);
   case 243: return rzfit_objc_field_num_to_string_for_music_info(field);
   case 273: return rzfit_objc_field_num_to_string_for_sleep_data_info(field);
   case 274: return rzfit_objc_field_num_to_string_for_sleep_data_raw(field);
   ...
   case 309: return rzfit_objc_field_num_to_string_for_mtb_cx(field);
   case 310: return rzfit_objc_field_num_to_string_for_race(field);
   case 311: return rzfit_objc_field_num_to_string_for_split_time(field);
   ...
   case 321: return rzfit_objc_field_num_to_string_for_power_mode(field);
   case 326: return rzfit_objc_field_num_to_string_for_gps_event(field);
   case 336: return rzfit_objc_field_num_to_string_for_ecg_summary(field);
   case 337: return rzfit_objc_field_num_to_string_for_ecg_raw_sample(field);
   case 338: return rzfit_objc_field_num_to_string_for_ecg_smooth_sample(field);
   case 356: return rzfit_objc_field_num_to_string_for_functional_metrics(field);
   case 358: return rzfit_objc_field_num_to_string_for_race_event(field);
   case 369: return rzfit_objc_field_num_to_string_for_training_readiness(field);
   ...
   case 378: return rzfit_objc_field_num_to_string_for_training_load(field);
   case 379: return rzfit_objc_field_num_to_string_for_sleep_schedule(field);
   case 382: return rzfit_objc_field_num_to_string_for_sleep_restless_moments(field);
   ...
   case 394: return rzfit_objc_field_num_to_string_for_cpe_status(field);
   case 397: return rzfit_objc_field_num_to_string_for_skin_temp_raw(field);
   case 398: return rzfit_objc_field_num_to_string_for_skin_temp_overnight(field);
   case 402: return rzfit_objc_field_num_to_string_for_hill_score(field);
   case 403: return rzfit_objc_field_num_to_string_for_endurance_score(field);
   case 409: return rzfit_objc_field_num_to_string_for_hsa_wrist_temperature_data(field);
   case 412: return rzfit_objc_field_num_to_string_for_nap(field);
   case 428: return rzfit_objc_field_num_to_string_for_workout_schedule(field);
   case 470: return rzfit_objc_field_num_to_string_for_sleep_disruption_severity_period(field);
   case 471: return rzfit_objc_field_num_to_string_for_sleep_disruption_overnight_severity(field);
...
FIT_FIELD_INFO rzfit_objc_field_info( FIT_UINT16 global_mesg_num, FIT_UINT16 field, FIT_INTERP_FIELD * interp ){
  switch(global_mesg_num){
    ...
    case 14: return rzfit_objc_field_info_for_data_screen(field);
    case 16: return rzfit_objc_field_info_for_alert(field);
    case 17: return rzfit_objc_field_info_for_range_alert(field);
    case 22: return rzfit_objc_field_info_for_device_used(field);
    case 29: return rzfit_objc_field_info_for_location(field);
    case 70: return rzfit_objc_field_info_for_map_layer(field);
    case 71: return rzfit_objc_field_info_for_routing(field);
    case 79: return rzfit_objc_field_info_for_user_metrics(field);
    case 89: return rzfit_objc_field_info_for_open_water_event(field);
    case 104: return rzfit_objc_field_info_for_device_status(field);
    case 105: return rzfit_objc_field_info_for_pad(field);
    case 113: return rzfit_objc_field_info_for_best_effort(field);
    case 114: return rzfit_objc_field_info_for_personal_record(field);
    case 140: return rzfit_objc_field_info_for_physiological_metrics(field);
    case 141: return rzfit_objc_field_info_for_epo_status(field);
    case 144: return rzfit_objc_field_info_for_multisport_activity(field);
    case 147: return rzfit_objc_field_info_for_sensor_settings(field);
    case 152: return rzfit_objc_field_info_for_metronome(field);
    case 170: return rzfit_objc_field_info_for_connect_iq_field(field);
    case 190: return rzfit_objc_field_info_for_golf_course(field);
    case 191: return rzfit_objc_field_info_for_golf_stats(field);
    case 192: return rzfit_objc_field_info_for_score(field);
    case 193: return rzfit_objc_field_info_for_hole(field);
    case 194: return rzfit_objc_field_info_for_shot(field);
    case 222: return rzfit_objc_field_info_for_alarm_settings(field);
    case 243: return rzfit_objc_field_info_for_music_info(field);
    case 273: return rzfit_objc_field_info_for_sleep_data_info(field);
    case 274: return rzfit_objc_field_info_for_sleep_data_raw(field);
    ...
    case 309: return rzfit_objc_field_info_for_mtb_cx(field);
    case 310: return rzfit_objc_field_info_for_race(field);
    case 311: return rzfit_objc_field_info_for_split_time(field);
    ...
    case 321: return rzfit_objc_field_info_for_power_mode(field);
    case 326: return rzfit_objc_field_info_for_gps_event(field);
    case 336: return rzfit_objc_field_info_for_ecg_summary(field);
    case 337: return rzfit_objc_field_info_for_ecg_raw_sample(field);
    case 338: return rzfit_objc_field_info_for_ecg_smooth_sample(field);
    case 356: return rzfit_objc_field_info_for_functional_metrics(field);
    case 358: return rzfit_objc_field_info_for_race_event(field);
    case 369: return rzfit_objc_field_info_for_training_readiness(field);
    ...
    case 378: return rzfit_objc_field_info_for_training_load(field);
    case 379: return rzfit_objc_field_info_for_sleep_schedule(field);
    case 382: return rzfit_objc_field_info_for_sleep_restless_moments(field);
    ...
    case 394: return rzfit_objc_field_info_for_cpe_status(field);
    case 397: return rzfit_objc_field_info_for_skin_temp_raw(field);
    case 398: return rzfit_objc_field_info_for_skin_temp_overnight(field);
    case 402: return rzfit_objc_field_info_for_hill_score(field);
    case 403: return rzfit_objc_field_info_for_endurance_score(field);
    case 409: return rzfit_objc_field_info_for_hsa_wrist_temperature_data(field);
    case 412: return rzfit_objc_field_info_for_nap(field);
    case 428: return rzfit_objc_field_info_for_workout_schedule(field);
    case 470: return rzfit_objc_field_info_for_sleep_disruption_severity_period(field);
    case 471: return rzfit_objc_field_info_for_sleep_disruption_overnight_severity(field);
    default: return (FIT_FIELD_INFO){.scale = 0, .offset = 0, .fit_type = 0, .fit_unit = 0, .fit_flag = 0 };
  }
}