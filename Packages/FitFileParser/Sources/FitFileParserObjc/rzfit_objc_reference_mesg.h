...
#define FIT_MESG_NUM_DATA_SCREEN                         ((FIT_MESG_NUM)14)    
#define FIT_MESG_NUM_ALERT                               ((FIT_MESG_NUM)16)    
#define FIT_MESG_NUM_RANGE_ALERT                         ((FIT_MESG_NUM)17)    
#define FIT_MESG_NUM_DEVICE_USED                         ((FIT_MESG_NUM)22)    
#define FIT_MESG_NUM_LOCATION                            ((FIT_MESG_NUM)29)    
#define FIT_MESG_NUM_MAP_LAYER                           ((FIT_MESG_NUM)70)    
#define FIT_MESG_NUM_ROUTING                             ((FIT_MESG_NUM)71)    
#define FIT_MESG_NUM_USER_METRICS                        ((FIT_MESG_NUM)79)    
#define FIT_MESG_NUM_OPEN_WATER_EVENT                    ((FIT_MESG_NUM)89)    
#define FIT_MESG_NUM_DEVICE_STATUS                       ((FIT_MESG_NUM)104)   
#define FIT_MESG_NUM_BEST_EFFORT                         ((FIT_MESG_NUM)113)   
#define FIT_MESG_NUM_PERSONAL_RECORD                     ((FIT_MESG_NUM)114)   
#define FIT_MESG_NUM_PHYSIOLOGICAL_METRICS               ((FIT_MESG_NUM)140)   
#define FIT_MESG_NUM_EPO_STATUS                          ((FIT_MESG_NUM)141)   
#define FIT_MESG_NUM_MULTISPORT_ACTIVITY                 ((FIT_MESG_NUM)144)   
#define FIT_MESG_NUM_SENSOR_SETTINGS                     ((FIT_MESG_NUM)147)   
#define FIT_MESG_NUM_METRONOME                           ((FIT_MESG_NUM)152)   
#define FIT_MESG_NUM_CONNECT_IQ_FIELD                    ((FIT_MESG_NUM)170)   
#define FIT_MESG_NUM_GOLF_COURSE                         ((FIT_MESG_NUM)190)   
#define FIT_MESG_NUM_GOLF_STATS                          ((FIT_MESG_NUM)191)   
#define FIT_MESG_NUM_SCORE                               ((FIT_MESG_NUM)192)   
#define FIT_MESG_NUM_HOLE                                ((FIT_MESG_NUM)193)   
#define FIT_MESG_NUM_SHOT                                ((FIT_MESG_NUM)194)   
#define FIT_MESG_NUM_ALARM_SETTINGS                      ((FIT_MESG_NUM)222)   
#define FIT_MESG_NUM_MUSIC_INFO                          ((FIT_MESG_NUM)243)   
#define FIT_MESG_NUM_SLEEP_DATA_INFO                     ((FIT_MESG_NUM)273)   
#define FIT_MESG_NUM_SLEEP_DATA_RAW                      ((FIT_MESG_NUM)274)   
...
#define FIT_MESG_NUM_MTB_CX                              ((FIT_MESG_NUM)309)   
#define FIT_MESG_NUM_RACE                                ((FIT_MESG_NUM)310)   
#define FIT_MESG_NUM_SPLIT_TIME                          ((FIT_MESG_NUM)311)   
...
#define FIT_MESG_NUM_POWER_MODE                          ((FIT_MESG_NUM)321)   
#define FIT_MESG_NUM_GPS_EVENT                           ((FIT_MESG_NUM)326)   
#define FIT_MESG_NUM_ECG_SUMMARY                         ((FIT_MESG_NUM)336)   
#define FIT_MESG_NUM_ECG_RAW_SAMPLE                      ((FIT_MESG_NUM)337)   
#define FIT_MESG_NUM_ECG_SMOOTH_SAMPLE                   ((FIT_MESG_NUM)338)   
#define FIT_MESG_NUM_FUNCTIONAL_METRICS                  ((FIT_MESG_NUM)356)   
#define FIT_MESG_NUM_RACE_EVENT                          ((FIT_MESG_NUM)358)   
#define FIT_MESG_NUM_TRAINING_READINESS                  ((FIT_MESG_NUM)369)   
#define FIT_MESG_NUM_RAW_BBI                             ((FIT_MESG_NUM)372)   
#define FIT_MESG_NUM_HSA_GYROSCOPE_DATA                  ((FIT_MESG_NUM)376)   
#define FIT_MESG_NUM_TRAINING_LOAD                       ((FIT_MESG_NUM)378)   
#define FIT_MESG_NUM_SLEEP_SCHEDULE                      ((FIT_MESG_NUM)379)   
#define FIT_MESG_NUM_SLEEP_RESTLESS_MOMENTS              ((FIT_MESG_NUM)382)   
...
#define FIT_MESG_NUM_CPE_STATUS                          ((FIT_MESG_NUM)394)   
#define FIT_MESG_NUM_SKIN_TEMP_RAW                       ((FIT_MESG_NUM)397)   
#define FIT_MESG_NUM_SKIN_TEMP_OVERNIGHT                 ((FIT_MESG_NUM)398)   
#define FIT_MESG_NUM_HILL_SCORE                          ((FIT_MESG_NUM)402)   
#define FIT_MESG_NUM_ENDURANCE_SCORE                     ((FIT_MESG_NUM)403)   
#define FIT_MESG_NUM_HSA_WRIST_TEMPERATURE_DATA          ((FIT_MESG_NUM)409)   
#define FIT_MESG_NUM_NAP                                 ((FIT_MESG_NUM)412)   
#define FIT_MESG_NUM_WORKOUT_SCHEDULE                    ((FIT_MESG_NUM)428)   
